  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved truck as @truck" do
        ...
        post :create, {:truck => { "name" => "invalid value" }}, valid_session
        assigns(:truck).should be_a_new(Truck)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested truck" do
        ...
        Truck.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => truck.to_param, :truck => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the truck as @truck" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Truck.any_instance.stub(:save).and_return(false)
        put :update, {:id => truck.to_param, :truck => { "name" => "invalid value" }}, valid_session
        assigns(:truck).should eq(truck)
      end
