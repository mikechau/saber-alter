...
describe ValuesController do
  ...
  let(:valid_attributes) { { "truck_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved value as @value" do
        ...
        post :create, {:value => { "truck_id" => "invalid value" }}, valid_session
        assigns(:value).should be_a_new(Value)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested value" do
        ...
        Value.any_instance.should_receive(:update_attributes).with({ "truck_id" => "1" })
        put :update, {:id => value.to_param, :value => { "truck_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the value as @value" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Value.any_instance.stub(:save).and_return(false)
        put :update, {:id => value.to_param, :value => { "truck_id" => "invalid value" }}, valid_session
        assigns(:value).should eq(value)
      end
